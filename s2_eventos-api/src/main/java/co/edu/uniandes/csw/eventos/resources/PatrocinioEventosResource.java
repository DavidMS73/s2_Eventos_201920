...
public class PatrocinioEventosResource {
    ...
    */
     ...
     *
     * @param patrociniosId El ID del patrocinio al cual se le va a asociar el evento
     ...
     * Error de lógica que se genera cuando no se encuentra el evento o el patrocinio.
     */
    @POST
    @Path("{eventosId: \\d+}")
   ...
   /**
     * Actualiza la lista de eventos de un patrocinio con la lista que se recibe en el
     * cuerpo
     *
     * @param patrociniosId El ID del patrocinio al cual se le va a asociar el evento
     ...
     *
     * @param patrociniosId El ID del patrocinio al cual se le va a desasociar el evento
