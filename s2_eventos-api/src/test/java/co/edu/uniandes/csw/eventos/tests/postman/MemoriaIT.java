...
import co.edu.uniandes.csw.eventos.resources.MemoriaResource;
...
/**
 * Pruebas de integracion del recurso de Memoria.
 *
...
public class MemoriaIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_eventos-api.war")//War del modulo api
                ...
                .addPackage(MemoriaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(MemoriaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
