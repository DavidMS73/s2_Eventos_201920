...
import co.edu.uniandes.csw.eventos.resources.PatrocinioResource;
...
/**
 * Pruebas de integracion del recurso de EventoUsuarios.
 *
 * @author Germán David Martínez Solano
 */
@RunWith(Arquillian.class)
public class EventoPatrociniosIT {

    private static final String COLLECTION = "EventoPatrociniosTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_eventos-api.war")//War del modulo api
                ...
                .addPackage(PatrocinioResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(PatrocinioDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
