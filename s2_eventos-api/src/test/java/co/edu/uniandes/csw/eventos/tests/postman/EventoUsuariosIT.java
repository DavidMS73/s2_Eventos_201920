...
import co.edu.uniandes.csw.eventos.resources.UsuarioResource;
...
public class EventoUsuariosIT {

    private static final String COLLECTION = "EventoUsuariosTests.postman_collection";
