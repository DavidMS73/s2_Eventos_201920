...
import co.edu.uniandes.csw.eventos.resources.PagoResource;
...
/**
 * Pruebas de integracion del recurso de Pago.
 *
...
public class PagoIT {
    ...
    private static final String COLLECTION = "Pago Resource Tests.postman_collection";
