...
/**
 * Pruebas de integracion del recurso de Patrocinio.
 *
 * @author Germán David Martínez Solano
 */
@RunWith(Arquillian.class)
public class PatrocinioIT {

    private static final String COLLECTION = "Patrocinio Resource Test.postman_collection";
