...
public class EventoLogic {
    ...
    public EventoEntity createEvento(EventoEntity evento) throws BusinessLogicException {
        ...
        /**Date fechaAdelante = sumarRestarDiasFecha(fechaComparar, 7);
        if (evento.getFechaInicio().before(fechaAdelante)) {
            throw new BusinessLogicException("No se puede crear un evento si no tiene una semana de anterioridad");
        }*/
